...
or when ``CURATORX_SQLITE_VEC=0`` — callers fall back to full exact cosine
scans. ``item_neighbors`` remains the UI/agent read cache either way.
"""
