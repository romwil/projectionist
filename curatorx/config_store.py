...
class Settings:
    ...
    # creation (Admin rotate, or env CURATORX_MCP_FULL_CONFIRM for stdio/CA).
    # Default false → the full key can propose but not self-confirm; a human
    # confirms on the web plane. See review finding H3.
